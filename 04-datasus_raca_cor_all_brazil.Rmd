...
```{r, eval=F}
saveRDS(racacor_df, "./data/racacor_df.rds")
```
...
saveRDS(dados_selected, "./data/dados_selected.rds")
...
```{r, eval=F}
saveRDS(dados_agregados_year, "./data/dados_agregados_year.rds")
```
...
```{r}
saveRDS(dados_appended_melted, "./data/dados_appended_melted.rds")
```
...
# saveRDS(dados_nb, "./data/dados_nb.rds")
